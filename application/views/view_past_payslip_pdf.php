...
if ($employee != null) {
	...
	<table border="1">
		<tr>
			<td align="center"><h1>STERLING ENGINEERING PTE LTD</h1>
				<p>Payment Voucher for the month of <?php print_r ($remuneration->get_month());?> (Employer Copy)</p></td>
		</tr>
		<tr>
			<td>
					...
					<tr>
						...
						<td colspan="3" width="50%">
							...
							<table border="1">
								...
								<tr>
									<td><b>Total Remuneration for <?php print_r($remuneration->get_month());?></b></td>
	...
	<p></p>
		...
		<tr>
			<td align="center"><h1>STERLING ENGINEERING PTE LTD</h1>
				<p>Payment Voucher for the month of <?php print_r($remuneration->get_month());?> (Employee Copy)</p></td>
		</tr>
		<tr>
			<td>
				<!-- Inner table for details-->
